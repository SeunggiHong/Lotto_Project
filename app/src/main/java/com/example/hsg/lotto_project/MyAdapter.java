...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == 0  ) {
            headerFlag = true;
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.top_header_item, parent,false);
        }
        //헤더가 아닌 나머지 콘텐츠들
        else {
            headerFlag = false;
    ...
    //헤더 바인드
    private void headerBindInit(final ViewHolder holder, final int position)
    {
          holder.topHeadertxt.setText(list.get(position).getName());
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mTextView, topHeadertxt;
        ...
        {
            topHeadertxt = (TextView) itemView.findViewById(R.id.topheadertext);
        }
